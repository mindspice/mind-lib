...
public class IVolVector2 implements IVector2 {
    private int x;
    private int y;

    IVolVector2(int x, int y) {
        this.x = x;
        this.y = y;
    }

    IVolVector2(float x, float y) {
        x = (int) x;
        y = (int) y;
    }

    IVolVector2(IVector2 other) {
        this.x = other.x();
        this.y = other.y();
    }
    ...
    @Override
    public IVolVector2 withXInc() {
        x += 1;
        return this;
    }

    @Override
    public IVolVector2 withYInc() {
        y += 1;
        return this;
    }

    @Override
    public IVolVector2 withXDec() {
        x -= 1;
        return this;
    }

    @Override
    public IVolVector2 withYDec() {
        y -= 1;
        return this;
    }

    @Override
    public IVolVector2 add(IVector2 other) {
        this.x += other.x();
        this.y += other.y();
        return this;
    }
    ...
    @Override
    public IVolVector2 subtract(IVector2 other) {
        this.x -= other.x();
        this.y -= other.y();
        return this;
    }
    ...
    @Override
    public IVolVector2 multiply(IVector2 other) {
        this.x *= other.x();
        this.y *= other.y();
        return this;
    }
    ...
    @Override
    public IVolVector2 divide(IVector2 other) {
        this.x /= other.x();
        this.y /= other.y();
        return this;
    }
    ...
    @Override
    public IVolVector2 scale(int scalar) {
        this.x *= scalar;
        this.y *= scalar;
        return this;
    }
